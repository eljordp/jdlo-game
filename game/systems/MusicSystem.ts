...
const TRACKS: Record<string, TrackDef> = {
  ...
  'home': {
    layers: [
      ...
      {
        notes: ['G2', 'R', 'B2', 'G2', 'C3', 'R', 'E2', 'C3',
                'D3', 'R', 'A2', 'D3', 'G2', 'B2', 'D3', 'G2'],
        bpm: 90,
        gain: 0.014,
        wave: 'triangle',
        filterFreq: 500,
      ...
      // Melody — warm hopeful line with movement
      {
        notes: ['G4', 'R', 'B4', 'A4', 'G4', 'E4', 'D4', 'R',
                'E4', 'G4', 'A4', 'R', 'B4', 'A4', 'G4', 'R',
                'C5', 'B4', 'A4', 'R', 'G4', 'E4', 'D4', 'R',
                'E4', 'R', 'G4', 'A4', 'B4', 'R', 'G4', 'R'],
        bpm: 90,
        gain: 0.010,
        wave: 'triangle',
        filterFreq: 1800,
      ...
      // Shimmer — high octave arpeggios for sparkle
      {
        notes: ['R', 'D5', 'G5', 'R', 'B4', 'R', 'D5', 'R',
                'R', 'E5', 'G5', 'R', 'A4', 'R', 'E5', 'R',
                'R', 'D5', 'B5', 'R', 'G4', 'R', 'D5', 'R',
                'R', 'E5', 'G5', 'R', 'B4', 'R', 'D5', 'R'],
        bpm: 90,
      ...
      // Pad — warm sustained harmony underneath
      {
        notes: ['G3', 'R', 'R', 'R', 'C4', 'R', 'R', 'R',
                'D4', 'R', 'R', 'R', 'C4', 'R', 'R', 'R'],
        bpm: 90,
        gain: 0.007,
        wave: 'sine',
