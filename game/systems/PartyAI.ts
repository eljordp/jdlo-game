...
const NPC_CONFIGS: PartyNPCConfig[] = [
  ...
  { id: 'girl4', sprite: 'npc_bikini2', drinkRate: 0.5, passOutThreshold: 6, danceBias: 0.8, talkBias: 0.7, isGirl: true, lines: GIRL_LINES },
  { id: 'girl5', sprite: 'npc_bikini1', drinkRate: 0.2, passOutThreshold: 7, danceBias: 0.5, talkBias: 0.7, isGirl: true, lines: GIRL_LINES },
  { id: 'girl6', sprite: 'npc_bikini2', drinkRate: 0.4, passOutThreshold: 6, danceBias: 0.7, talkBias: 0.5, isGirl: true, lines: GIRL_LINES },
  ...
  { id: 'dude4', sprite: 'npc_generic', drinkRate: 0.5, passOutThreshold: 7, danceBias: 0.7, talkBias: 0.4, isGirl: false, lines: DUDE_LINES },
  { id: 'dude5', sprite: 'npc_generic', drinkRate: 0.3, passOutThreshold: 8, danceBias: 0.5, talkBias: 0.6, isGirl: false, lines: DUDE_LINES },
  { id: 'dude6', sprite: 'npc_generic', drinkRate: 0.7, passOutThreshold: 6, danceBias: 0.6, talkBias: 0.5, isGirl: false, lines: DUDE_LINES },
  { id: 'dude7', sprite: 'npc_generic', drinkRate: 0.4, passOutThreshold: 7, danceBias: 0.4, talkBias: 0.7, isGirl: false, lines: DUDE_LINES },
];
...
const PARTY_EVENTS: PartyEvent[] = [
  ...
  { time: 30000, action: 'shout', npcId: 'girl1', text: 'Hot tub time!!' },
  { time: 30000, action: 'move', npcId: 'girl1', waypoint: 'hot_tub' },
  { time: 30000, action: 'move', npcId: 'girl2', waypoint: 'hot_tub' },
  { time: 50000, action: 'move', npcId: 'girl4', waypoint: 'hot_tub_deck' },
