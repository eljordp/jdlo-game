    ...
    this.tweens.add({
      ...
      onComplete: () => {
        ...
        this.dialogue.show([
          ...
          { speaker: 'Pops', text: 'Ten acres. Petite sirah. The French call it durif.' },
          ...
          { speaker: 'Pops', text: 'Three thousand a ton. A good year runs seventy tons.' },
          { speaker: 'Pops', text: 'You do the math. I know you\'re already doing it. You\'ve been doing it since you were six.' },
          { speaker: 'JP\'s Mind', text: 'Two hundred and ten thousand. A year. Growing out of my tuition.' },
          { speaker: 'Pops', text: 'Chuck up the road bottles his as Grand Durif. Forty a bottle. A ton makes seven hundred bottles.' },
          { speaker: 'JP\'s Mind', text: 'The grapes are two hundred K. The bottles are millions. There\'s a whole ladder buried in this dirt.' },
