...
const ch4Extras: Record<string, DialogueLine[]> = {
  ...
  ch4_crash: [
    ...
    { speaker: 'Narrator', text: 'Frank comes sprinting from the farmhouse.' },
    { speaker: 'Frank', text: 'WHAT THE HELL DID YOU DO?!' },
    { speaker: 'JP', text: 'I... it was an accident.' },
    { speaker: 'Frank', text: 'That irrigation line costs more than your paycheck! Were you on your damn phone again?!' },
    { speaker: 'JP', text: '...yeah.' },
    ...
    { speaker: 'JP', text: 'Frank, I\'m done. I appreciate the job but I gotta go.' },
    { speaker: 'Frank', text: 'Go? Go where? To do what?' },
    { speaker: 'JP', text: 'I don\'t know yet. But not this.' },
    { speaker: 'Frank', text: '...good luck, kid.' },
